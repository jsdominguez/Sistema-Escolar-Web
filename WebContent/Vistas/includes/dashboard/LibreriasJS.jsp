...
<script type="text/javascript" src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/bootstrap/bootstrap.min.js"></script>        
<!-- END PLUGINS -->

<!-- START THIS PAGE PLUGINS-->      
<script type="text/javascript" src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/morris/raphael-min.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/morris/morris.min.js"></script>     

<script type='text/javascript' src='${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/icheck/icheck.min.js'></script>        

<script type="text/javascript" src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js"></script>


<script src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/datatables/DataTables-1.10.24/js/jquery.dataTables.min.js"></script>

<script src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/datatables/DataTables-1.10.24/js/dataTables.bootstrap.min.js"></script>

<script src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/datatables/Responsive-2.2.7/js/dataTables.responsive.min.js"></script>

<script src="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/datatables/Responsive-2.2.7/js/responsive.bootstrap.min.js"></script>

<!-- END THIS PAGE PLUGINS-->        

<!-- START TEMPLATE -->
<!--<script type="text/javascript" src="/ProyectoIntegrador2/Vistas/Resources/dashboard/js/settings.js"></script>-->
