...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Vistas/Resources/dashboard/js/plugins/bootstrap-select/dist/css/selectize.bootstrap3.css">
                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
		                    ...
		                    <div class="col-md-12">
		                        ...
		                        <table id="tblGradoSeccion" class="table responsive dt-responsive text-center" width="100%">
		                           <thead>
		                                 ...
		                                 <th class="text-center">Estado Ingreso</th>
		                           </thead>
		                        </table>
	...
	<script type="text/javascript" src="Grado_Seccion.js"></script>
</html>
