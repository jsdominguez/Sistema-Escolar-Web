...
<li>
    <a href="../Alumno/CrudAlumno.jsp"><span class="fa fa-files-o"></span> <span class="xn-text">Alumnos</span></a>
</li>
...
<li class="active">
    <a href="#"><span class="fa fa-file-text-o"></span> <span class="xn-text">Grado / Seccion</span></a>
</li>